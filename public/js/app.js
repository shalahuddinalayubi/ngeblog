...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  props: ['oldValue', 'hasTags'],
  created: function created() {
    var _this = this;

    if (!!this.oldValue) {
      this.oldValue.forEach(function (element) {
        if (!_this.value.includes(element)) {
          _this.value.push(element);
        }
      });
    } else if (!!this.hasTags) {
      this.hasTags.forEach(function (element) {
        if (!_this.value.includes(element.name)) {
          _this.value.push(element.name);
        }
      });
    }
  },
  methods: {
    ...
    getTags: function getTags(query) {
      var _this2 = this;

      this.isLoading = true;
      axios__WEBPACK_IMPORTED_MODULE_1___default().get("http://127.0.0.1:8000/api/" + "tags?filter[name]=".concat(query)).then(function (response) {
        _this2.isLoading = false;
        response.data.data.forEach(function (tag) {
          if (!_this2.options.includes(tag.name)) {
            _this2.options.push(tag.name);
          }
        });
      });
    }
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "render": () => (/* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Tag_vue_vue_type_template_id_8d320b02___WEBPACK_IMPORTED_MODULE_0__.render),
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/Tag.vue?vue&type=template&id=8d320b02&":
/*!***************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/Tag.vue?vue&type=template&id=8d320b02& ***!
  \***************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
  ...
  return _c(
    ...
    [
      _c("multiselect", {
        ...
        on: { tag: _vm.addTag, "search-change": _vm.getTags },
        model: {
          value: _vm.value,
          callback: function ($$v) {
            _vm.value = $$v
      ...
      _vm._l(_vm.value, function (item, index) {
        return _c("div", { key: index, staticClass: "hidden" }, [
          _c("input", {
