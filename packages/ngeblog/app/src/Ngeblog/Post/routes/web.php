...
Route::get('/posts/{id}', [\Ngeblog\Post\Http\Controllers\PostController::class, 'show'])->name('posts.show');
...
Route::get('/tags/{tag}/posts', [\Ngeblog\Post\Http\Controllers\TagController::class, 'show'])->name('tags.posts.show');
